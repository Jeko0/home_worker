...
export const Navbar = () => {
  ...
  return (
    <Fragment>
      <nav     className="relative flex flex-wrap bg-slate-200 px-2 items-center justify-between py-3 dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600  mb-3">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a onClick={handleNavigateHomePage} className="flex items-center">
              <IconOption/>
              <span className="self-center font-semibold whitespace-nowrap dark:text-white ml-7 text-2xl">Home Worker</span>
          </a>
          ...
          <div className="hidden justify-between mr-12 items-center w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-white md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-slate-200 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a onClick={handleNavigateHomePage} className="block py-2 pr-4 pl-3 text-black bg-blue-700 rounded md:bg-transparent md:text-black md:p-0 dark:text-white text-xl" aria-current="page">Home</a>
              </li>
              <li>
              ...
              <li>
                <a onClick={handleNavigateSubjectsPage} className="block py-2 pr-4 pl-3 text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 text-xl">Our Services</a>
              </li>
              <li>
